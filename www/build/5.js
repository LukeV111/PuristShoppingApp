...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__detail2__ = __webpack_require__(842);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_rxjs_add_operator_map__ = __webpack_require__(843);
...
var Detail2Page = (function () {
    ...
    */
    ...
    Detail2Page.prototype.blendIncrement = function () {
        this.currentNumber++;
    ...
    Detail2Page.prototype.blendDecrement = function () {
        if (this.currentNumber == 1) {
        }
        else {
            this.currentNumber--;
    ...
    Detail2Page.prototype.SOIncrement = function () {
        this.currentNumber++;
    ...
    Detail2Page.prototype.SODecrement = function () {
        if (this.currentNumber == 1) {
        }
        else {
            this.currentNumber--;
    ...
    Detail2Page.prototype.DeIncrement = function () {
        this.currentNumber++;
    ...
    Detail2Page.prototype.DeDecrement = function () {
        if (this.currentNumber == 1) {
        }
        else {
            this.currentNumber--;
